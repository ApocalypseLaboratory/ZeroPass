...
namespace ZeroPass
{
    ...
    {
        [MyCmpAdd] protected StateMachineController stateMachineController;
        ...
        where StateMachineInstanceType : StateMachine.Instance
    {
        ...
        public StateMachineInstanceType smi
        {
            get
            {
                if (_smi == null)
                {
                    _smi = (StateMachineInstanceType)Activator.CreateInstance(typeof(StateMachineInstanceType),
                        new object[1]
                        {
                            this
                        });
