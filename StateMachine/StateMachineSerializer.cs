        ...
        private class Entry
        {
            ...
            public Entry(StateMachine.Instance smi, BinaryWriter entry_writer)
            {
                ...
                foreach (StateMachine.Parameter.Context context in array)
                {
                    ...
                    entry_writer.WriteRString(context.GetType().FullName);
                    entry_writer.WriteRString(context.parameter.name);
            ...
            public void Serialize(BinaryWriter writer)
            {
                ...
                writer.WriteRString(type.FullName);
                writer.WriteRString(currentState);
            }
